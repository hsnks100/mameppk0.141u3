...
enum
{
	...
	KEYCODE_KANA = STANDARD_CODE(KEYBOARD, 0, SWITCH, NONE, KANA),
	KEYCODE_CONVERT = STANDARD_CODE(KEYBOARD, 0, SWITCH, NONE, CONVERT),
	KEYCODE_NONCONVERT = STANDARD_CODE(KEYBOARD, 0, SWITCH, NONE, NONCONVERT),
